...
# Using the `where` class method, fetch stores that carry men's apparel and assign to @mens_stores
...
# Loop through and output the name and annual revenue of each women's store meeting the criteria
